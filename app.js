...
server.on("request", function(req, res) {
  ...
  var Response = {
    renderHTML: function() {
      var contens = fs.readFile("./public/index.html", "utf-8", function(
        err,
        data
      ) {
        res.writeHead(200, {
    ...
    renderCSS: function() {
      var contens = fs.readFile("./public/css/map.css", "utf-8", function(
        err,
        data
      ) {
        res.writeHead(200, {
    ...
    programStart: function() {
      var contens = fs.readFile(
        "./public/js/program-start.js",
        "utf-8",
        function(err, data) {
          res.writeHead(200, {
    ...
    map: function() {
      var contens = fs.readFile("./public/js/map.js", "utf-8", function(
        err,
        data
      ) {
        res.writeHead(200, {
    ...
    showPlan: function() {
      var contens = fs.readFile("./public/js/show-plan.js", "utf-8", function(
        err,
        data
      ) {
        res.writeHead(200, {
    ...
    showRoute: function() {
      var contens = fs.readFile("./public/js/show-route.js", "utf-8", function(
        err,
        data
      ) {
        res.writeHead(200, {
    ...
    directionsService: function() {
      var contens = fs.readFile(
        "./public/js/distance-matrix-service.js",
        "utf-8",
        function(err, data) {
          res.writeHead(200, {
            "content-Type": "text/plain"
    ...
    googleApis: function() {
      var contens = fs.readFile(
        "https://maps.googleapis.com/maps/api/js?key=" +
          apiKey +
          "&libraries=places&callback=programStart",
        "utf-8",
        function(err, data) {
          res.writeHead(200, {
            "content-Type": "text/plain"
    ...
    apiServer: function(getDirectionsObj) {
      ...
      getDirectionsObj["origin"] =
        getDirectionsObj["origin_lat"] + ", " + getDirectionsObj["origin_lng"];
      getDirectionsObj["destination"] =
        getDirectionsObj["destination_lat"] +
        ", " +
        getDirectionsObj["destination_lng"];

      if ("arrival_time" in getDirectionsObj) {
        getDirectionsObj["arrival_time"] = new Date(
          getDirectionsObj["arrival_time"] + " UTC"
        );
      }

      if ("departure_time" in getDirectionsObj) {
        getDirectionsObj["departure_time"] = new Date(
          getDirectionsObj["departure_time"] + " UTC"
        );
      }
      ...
      googleMapsClient.directions(getDirectionsObj, function(err, response) {
        // console.log('HELLO')
        console.log(err);
